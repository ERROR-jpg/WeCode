...
var app = (function () {
  ...
  `);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 19, 4, 598);
    			option0.__value = "C";
    			option0.value = option0.__value;
    			add_location(option0, file$3, 23, 2, 686);
    			option1.__value = "Cpp ";
    			option1.value = option1.__value;
    			add_location(option1, file$3, 24, 2, 718);
    			option2.__value = "Python";
    			option2.value = option2.__value;
    			add_location(option2, file$3, 25, 2, 755);
    			option3.__value = "Java";
    			option3.value = option3.__value;
    			add_location(option3, file$3, 26, 2, 797);
    			attr_dev(select, "name", "lang");
    			attr_dev(select, "id", "lang");
    			add_location(select, file$3, 22, 2, 652);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => window.open('/');
