...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$3, 5, 4, 62);
    			attr_dev(header, "class", "svelte-1mmlrgr");
    			add_location(header, file$3, 4, 0, 48);
    		},
    ...
    class Header extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { imageSrc: 0 });
    ...
    const file$2 = "src\\components\\SideNav.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$2, 9, 4, 224);
    			attr_dev(i1, "class", "fa fa-plus icons svelte-8z2fo7");
    			add_location(i1, file$2, 10, 4, 288);
    			attr_dev(div, "class", "side-bar svelte-8z2fo7");
    			add_location(div, file$2, 8, 2, 196);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(i0, "click", /*downloadCode*/ ctx[0], false, false, false),
    					listen_dev(i1, "click", /*click_handler*/ ctx[1], false, false, false)
    				];
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ downloadCodeFromEditor, downloadCode });
    	return [downloadCode, click_handler];
    }
    ...
    const file$1 = "src\\components\\CodeEditor.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 9, 2, 202);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "wrapper svelte-37glzd");
    			add_location(div, file, 7, 2, 229);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Header, SideNav, CodeEditor });
    	return [];
    }
